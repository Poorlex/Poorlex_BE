drop table if exists alarm_reaction;
drop table if exists battle;
drop table if exists battle_alarm;
drop table if exists battle_alarm_view_history;
drop table if exists battle_notification;
drop table if exists battle_participant;
drop table if exists expenditure;
drop table if exists friend;
drop table if exists goal;
drop table if exists member;
drop table if exists member_alarm;
drop table if exists alarm_allowance;
drop table if exists member_point;
drop table if exists vote;
drop table if exists voting_paper;
drop table if exists weekly_budget;
drop table if exists battle_success_history;
