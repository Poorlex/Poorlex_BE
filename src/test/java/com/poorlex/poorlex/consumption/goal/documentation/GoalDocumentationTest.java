package com.poorlex.poorlex.consumption.goal.documentation;

import com.poorlex.poorlex.consumption.goal.controller.GoalController;
import com.poorlex.poorlex.consumption.goal.domain.GoalDurationType;
                                 ...
                                 responseFields(fieldWithPath("[]").description("진행중인 목표 리스트"))
                                         .andWithPrefix("[].",
                                                        ...
                                                        fieldWithPath("name").type(JsonFieldType.STRING)
                                                                .description("목표 명"),
                                                        fieldWithPath("durationType").type(JsonFieldType.STRING)
                                                                .description("목표 기간 타입"),
                                                        fieldWithPath("amount").type(JsonFieldType.NUMBER)
                                                                .description("목표 금액"),
                                                        fieldWithPath("dayLeft").type(JsonFieldType.NUMBER)
                                                                .description("종료까지 남은 총 일수"),
                                                        fieldWithPath("monthLeft").type(JsonFieldType.NUMBER)
                                                                .description("종료까지 남은 총 개월 수"),
                                                        fieldWithPath("startDate").type(JsonFieldType.STRING)
                                                                .description("목표 시작 날짜"),
                                                        fieldWithPath("endDate").type(JsonFieldType.STRING)
                                                                .description("목표 종료 날짜")
                                         )
                        )
                );
    }
                ...
                .andDo(
                        document("goal-find-ids",
                                 ...
                                 responseFields(fieldWithPath("[]").description("목표 리스트"))
                                         .andWithPrefix("[].",
                                                        fieldWithPath("goalId").type(JsonFieldType.NUMBER)
                                                                .description("회원이 등록한 목표 Id")
                                         )
                        )
                );
    }
        ...
        result.andExpect(status().isOk())
                .andDo(
                        document("goal-find-types",
                                 ...
                                 responseFields()
                                         .andWithPrefix("[].",
                                                        fieldWithPath("recommendGoalNames[]").description(
                                                                "목표 타입별 추천 목표명"),
