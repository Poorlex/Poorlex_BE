                                 ...
                                 responseFields(fieldWithPath("[]").description("배틀 알림 리스트 ( 기본 )"))
                                         .andWithPrefix("[].",
                                                        ...
                                                        fieldWithPath("memberId").type(JsonFieldType.NUMBER)
                                                                .description("알림 생성 멤버 Id"),
                                                        fieldWithPath("alarmType").type(JsonFieldType.STRING)
                                                                .description("알림 타입"),
                        ...
                        document("battle-alarm-find-vote",
                                 ...
                                 responseFields(fieldWithPath("[]").description("배틀 알림 리스트 ( 투표 )"))
                                         .andWithPrefix("[].",
                                                        fieldWithPath("alarmType").type(JsonFieldType.STRING)
                                                                .description("알림 타입"),
                                                        fieldWithPath("voteId").type(JsonFieldType.NUMBER)
                                                                .description("투표 Id"),
                                                        fieldWithPath("voteMakerNickname").type(JsonFieldType.STRING)
                                                                .description("투표 생성 참가자 닉네임"),
                                                        fieldWithPath("voteName").type(JsonFieldType.STRING)
                                                                .description("투표명"),
                                                        fieldWithPath("voteStatus").type(JsonFieldType.STRING)
                                                                .description("투표 상태"),
                                                        fieldWithPath("voteAmount").type(JsonFieldType.NUMBER)
                                                                .description("투표 금액"),
                                                        fieldWithPath("voteAgreeCount").type(JsonFieldType.NUMBER)
                                                                .description("투표 찬성 표 수"),
                                                        fieldWithPath("voteDisagreeCount").type(JsonFieldType.NUMBER)
                                                                .description("투표 반대 표 수"),
                                                        fieldWithPath("createdAt").type(JsonFieldType.STRING)
                                 ...
                                 responseFields(fieldWithPath("[]").description("배틀 알림 리스트 ( 투표 참가 표 )"))
                                         .andWithPrefix("[].",
                                                        ...
                                                        fieldWithPath("agree").type(JsonFieldType.BOOLEAN)
                                                                .description("투표 찬성 여부"),
                                                        fieldWithPath("createdAt").type(JsonFieldType.STRING)
                                                                .description("투표 참가표 생성 시간")
                                         )
                        ));
    }
                        ...
                        document("battle-alarm-find-reaction",
                                 ...
                                 responseFields(fieldWithPath("[]").description("배틀 알림 리스트 ( 알림 반응 )"))
                                         .andWithPrefix("[].",
                                                        ...
                                                        fieldWithPath("alarmReactionContent").type(JsonFieldType.STRING)
                                                                .description("반응 내용"),
                                                        fieldWithPath("createdAt").type(JsonFieldType.STRING)
                                                                .description("알림 반응 생성 시간")
                                         )
                        ));
    }
